...
namespace Tema3Camera
{
	...
	public:
		...
		void MoveForward(float distance)
		{
			...
			// Example: If you rotate up/down your head and walk forward you will still keep the same relative distance
		...
		void TranslateRight(float distance)
		{
			...
			// Usually translation using camera "right' is not very useful because if the camera is rotated around the
			// "forward" vector translation over the right direction will have an undesired effect; the camera will get
			// closer or farther from the ground
			// Using the projected right vector (onto the ground plane) makes more sense because we will keep the same
